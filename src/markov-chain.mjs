...
/**
 * Generates a chunk of text from a marvok model.
 * Model is generated by the parse-corpus script.
 * 
 * @param {Object} stateModel A state model, generated by the parse-corpus script
 * @param {Function} [logger] A logging function, if desired
 */
